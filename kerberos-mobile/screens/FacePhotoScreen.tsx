...
export default function FacePhoto({ navigation, route }: any) {
    const { ID_URI } = route.params;
    ...
    return (
        <View style={styles.container}>
            <View style={styles.topContainer}>
                <Text style={styles.title}>Verify ID Ownership</Text>
                <Text style={styles.body}>Take a photo of your face </Text>
            </View>
                ...
                {image ? (
                    <View style={styles.buttonGroup}>
                        ...
                        <Button
                            ...
                            onPress={async () =>
                                navigate.navigate("FaceAnalyser", { ID_URI: ID_URI, imageURI: image })
                            }
                        >
                            Continue
                        </Button>
